...
def inizializza_database():
    ...
    try:
        ...
        print(
            "✅ Database monitoraggio inizializzato",
            flush=True
        )
...
def estrai_bandi_pagina(url):
    ...
    try:
        ...
        r = requests.get(
            ...
            headers={
                "User-Agent":
                    "Mozilla/5.0 Monitoraggio-Bandi-Campania"
            }
        )
...
# ============================================================
# SALVATAGGIO E CONFRONTO DATABASE
# ============================================================
    ...
    try:
        ...
        for bando in bandi:
            ...
            if "SRD03.html" in url:
                ...
                print(
                    f"🔎 DEBUG SRD03 - URL: {url}",
                    flush=True
                )

                print(
                    f"🔎 DEBUG SRD03 - NUOVA IMPRONTA: "
                    f"{nuova_impronta}",
                    flush=True
                )
            ...
            if risultato is None:
                ...
                # NUOVO BANDO RILEVANTE
                # Non viene classificato come modifica
            ...
            # ====================================================
                ...
                # =================================================
                    ...
                    # La classificazione viene fatta
                    # SOLO per i bandi già presenti
                    # che risultano modificati.

                    if bando_rilevante(bando):

                        tipo_modifica = classifica_modifica(
                            bando
                        )
...
def verifica_integrita_fonte():
    ...
    try:
        ...
        print(
            f"DEBUG 4 - bandi estratti: {len(bandi)}",
            flush=True
        )
